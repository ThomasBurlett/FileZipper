...
public class GUI extends JFrame {
	...
	private void initUI() {
		...
		final JButton addFileButton = new JButton("Add a file(s) to be zipped.");
		...
		final JButton saveFileButton = new JButton("Name file and specify output location.");
		...
		final JButton clearFilesButton = new JButton("Reset");
